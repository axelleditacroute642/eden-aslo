            ...
            {site.contact.socials.whatsapp && (
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 hover:text-eden-gold-light transition-colors"
                >
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-eden-cream/10 text-eden-gold-light">
