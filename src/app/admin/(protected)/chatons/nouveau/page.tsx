...
export default function AdminNewKittenPage() {
  return (
    <div className="max-w-2xl">
      <h1 className={pageTitleClass}>Ajouter un chaton</h1>
      <p className="text-sm text-slate-500 mb-6">
        La généalogie et les photos supplémentaires se complètent après la création,
        depuis la fiche du chaton.
      </p>

      <form action={addKitten} className={`${cardClass} grid gap-4 sm:grid-cols-2`}>
        ...
        <div>
          ...
          <select id="status" name="status" className={inputClass} defaultValue="disponible">
        ...
        <div>
          ...
          <input id="price" name="price" type="number" min="0" step="1" className={inputClass} />
        </div>
        ...
        <div className="sm:col-span-2">
          <SubmitButton pendingLabel="Création…">Créer le chaton</SubmitButton>
        </div>
      </form>
    </div>
  );
